...
const Register = () => {
    ...
    const { user, setUser, loading,logOut, signInWithGoogle, createUser, updateUserProfile } = useAuthHook();
                    ...
                    <form onSubmit={handleSignIn}>
                        ...
                        <div className='mt-4'>
                            ...
                            <input type="file" name='photo'
                                className='block w-full px-4 py-2 text-gray-700 bg-white border rounded-lg    focus:border-blue-400 focus:ring-opacity-40  focus:outline-none focus:ring focus:ring-blue-300' id="" />
                        </div>
                        <div className='mt-4'>
                            <label
                                className='block mb-2 text-sm font-medium text-gray-600 '
